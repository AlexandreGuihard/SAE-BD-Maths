...
insert into PIECE values (5, 'Panneau de fuselage', 'Panneau', 300, 1);

insert into CONTENIR values (5, 1, 8);
insert into CONTENIR values (5, 2, 20);
insert into CONTENIR values (5, 3, 4);
insert into CONTENIR values (5, 4, 1);